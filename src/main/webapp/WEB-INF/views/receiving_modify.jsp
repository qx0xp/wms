...
<body>
	<div id="wrap">
		...
		<div class="modal-content">
		    ...
		    <h5 class="modal-title" id="exampleModalLabel">입고수정</h5>
		    </div>
		    <div class="modal-body">
		    	<form action="receiving_modify" id="target1" method="post">
		        <table>
		            <tr>
		            ...
		            <tr>
		                <th>입고예정날짜</th>
		                <td><input type="date" class="box" value="${modify.expect_date}" name="expect_date" readonly></td>
		            </tr>
		            <tr>
		                <th>품목코드</th>
...
$(document).ready(function(){	
	...
	$("#receiving_modify").on("click",function(){
		...
		if(expect_quantity==0){
			 alert("0은 입력할 수 없습니다.");
			 return false;
		 }
		
		
		var frm = $('#target1').serialize();

		//입고 수정
	      $.ajax({
	            method : "post",
	            url : "receiving_modify",
	            data : frm,
	            async : false,
	            dataType : "json",
