...
<%@ include file="header.jsp" %>
    ...
    <div class="content">
        <h2 class="title"><div class="triangle"></div>재고조회</h2>
        <form action="inventory_list" id="actionForm" method="get">
        ...
        <div class="list">
            <table>
                <tr>
                	<th style="display:none;" width="10%">재고코드</th>
                    <th width="10%">품목코드</th>
                    <th width="35%">품목명</th>
                    <th width="10%">예정재고</th>
                    <th width="10%">실재고</th>
	            ...
	            <tr>
	            	<td style="display:none;"><c:out value="${list.inventory_id}"/></td>
	           		<td><c:out value="${list.raw_id}"/></td>
	           		<td><c:out value="${list.raw_name}"/></td>
	           		<td><c:out value="${list.inventory_quantity}"/></td>
	           		<td><c:out value="${list.real_quantity}"/></td>
	           		<td><c:out value="${list.storage_name}"/></td>
	           		<td><c:out value="${list.storageArea_name}"/></td>
            	</tr>
		        </c:forEach>
            </table>
        </div>
