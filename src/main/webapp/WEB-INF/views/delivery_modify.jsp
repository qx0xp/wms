...
<body>
	<div id="wrap">
		...
		<div class="modal-content">
		    ...
		    <h5 class="modal-title" id="exampleModalLabel">출고수정</h5>
		    </div>
		    <div class="modal-body">
		        ...
		        <table>
		            ...
		            <tr>
		                <th>출고예정날짜</th>
		                <td><input type="date" id="d_expect_date" class="box" value="${modify.d_expect_date}" name="d_expect_date" readonly></td>
		            </tr>
		            <tr>
		                <th>품목코드</th>
		            ...
		            <tr>
		                <th>출하지</th>
		                <td><input class="box" type="text" value="${modify.shipment_name}" readonly></td>
		            </tr>
		        </table>
		    ...
		    <div class="modal-footer">
		    	<button type="submit" class="btn btn-primary" id="delivery_modify">변경</button>
		    </div>
		</div>
		</div>
	</div>   
...
$(document).ready(function(){	
	// 변경 클릭
	$("#delivery_modify").on("click",function(e){
		e.preventDefault();
		...
		//유효성 검사
	    if(max_quantity < d_expect_quantity){
