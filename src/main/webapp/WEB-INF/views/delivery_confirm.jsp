...
<body>
	...
	<div class="content">
    	<h2 class="title"><div class="triangle"></div>출고확정현황</h2>
        <form id="actionForm" action="/ovolo/delivery_confirm" method="get">
        ...
        <div class="list">
        	<table>
            	<tr>
                    <th style="display:none;" width="10%">출고번호</th>
                    <th width="10%">출고날짜</th>
                    <th width="10%">품목코드</th>
                    <th width="30%">품목명</th>
                    <th width="10%">출고수량(개)</th>
                    <th width="10%">창고명</th>
                    <th width="10%">구역명</th>
                    <th width="10%">출하지</th>
                </tr>
                <c:forEach items="${d_confirm_list}" var="d_confirm">               
                <tr>                               
                    <td style="display:none;">${d_confirm.delivery_id}</td>
                    <td>${d_confirm.delivery_date}</td>
                    <td>${d_confirm.raw_id}</td>
                    <td>${d_confirm.raw_name}</td>
                    <td>${d_confirm.delivery_quantity}</td>
                    <td>${d_confirm.storage_name}</td>
                    <td>${d_confirm.storageArea_name}</td>
                    <td>${d_confirm.shipment_name}</td>
                </tr>
                </c:forEach>
			</table>
        </div>
